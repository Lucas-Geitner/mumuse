...
var Router = function (_EventEmitter) {
  ...
  function Router(pathname, query) {
    ...
    _this.components = (0, _defineProperty3.default)({}, _this.route, { Component: Component, ctx: ctx });
  ...
  (0, _createClass3.default)(Router, [{
    ...
    value: function () {
      var _ref9 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(route, pathname, query) {
        var routeInfo, data, ctx, _data, _ctx;
        ...
        return _regenerator2.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 4:
                data = routeInfo.data = _context4.sent;
              ...
              case 15:
                _data = routeInfo.data = { Component: this.ErrorComponent, ctx: { err: _context4.t0 } };
                _ctx = (0, _extends3.default)({}, _data.ctx, { pathname: pathname, query: query });
                _context4.next = 19;
                return this.getInitialProps(_data.Component, _ctx);
