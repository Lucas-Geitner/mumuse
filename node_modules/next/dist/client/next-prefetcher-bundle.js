...
self.addEventListener('fetch', e => {
  ...
  try {
    for (var _iterator = e.request.headers.getAll('accept')[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var a = _step.value;
