      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            _context3.next = 12;
            return _promise2.default.all([Component.getInitialProps ? Component.getInitialProps(ctx) : {}, (0, _readPage2.default)((0, _path.join)(dir, '.next', 'bundles', 'pages', page)), (0, _readPage2.default)((0, _path.join)(dir, '.next', 'bundles', 'pages', dev ? '_error-debug' : '_error'))]);
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 3;
            return (0, _readPage2.default)((0, _path.join)(dir, '.next', 'bundles', 'pages', page));
