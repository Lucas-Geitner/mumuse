...
var NextScript = exports.NextScript = function (_Component4) {
  ...
  (0, _createClass3.default)(NextScript, [{
    key: 'render',
    value: function render() {
      var staticMarkup = this.context._documentProps.staticMarkup;


      return _react2.default.createElement(
        'div',
        null,
        staticMarkup ? null : _react2.default.createElement('script', { type: 'text/javascript', src: '/_next/commons.js' }),
        staticMarkup ? null : _react2.default.createElement('script', { type: 'text/javascript', src: '/_next/main.js' })
      );
    }
  }]);
  return NextScript;
